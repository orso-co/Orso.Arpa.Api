    ...
    public partial class AddedGermanTranslations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("39e5d409-aa17-4bcc-94dc-dc5b576fd910"), new DateTime(2021, 6, 16, 15, 30, 19, 390, DateTimeKind.Local).AddTicks(1201), "LocalizationSeedData", false, "Invalid cookie supplied", "de", null, null, "Validator", "Ungültiges Cookie angegeben" },
                    { new Guid("4899a356-74c0-4f48-9ca5-2a716f7718ab"), new DateTime(2021, 6, 16, 15, 30, 19, 389, DateTimeKind.Local).AddTicks(7493), "LocalizationSeedData", false, "This request requires a valid cookie to be provided", "de", null, null, "Validator", "Diese Anfrage erfordert einen gültigen Cookie" },
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1cc1999c-eec3-4891-a833-798a8ec6baae"), new DateTime(2021, 6, 16, 15, 30, 19, 386, DateTimeKind.Local).AddTicks(6960), "LocalizationSeedData", false, "Invalid cookie supplied", "en", null, null, "Validator", "Please try to login again" },
                    { new Guid("4899a356-74c0-4f48-9ca5-2a716f7718ab"), new DateTime(2021, 6, 16, 15, 30, 19, 389, DateTimeKind.Local).AddTicks(7493), "LocalizationSeedData", false, "This request requires a valid cookie to be provided", "de", null, null, "Validator", "Diese Anfrage erfordert einen gültigen Cookie" },
                    { new Guid("39e5d409-aa17-4bcc-94dc-dc5b576fd910"), new DateTime(2021, 6, 16, 15, 30, 19, 390, DateTimeKind.Local).AddTicks(1201), "LocalizationSeedData", false, "Invalid cookie supplied", "de", null, null, "Validator", "Ungültiges Cookie angegeben" },
                    { new Guid("c9f96e9b-5829-48d9-a58c-c3fc3cb284a1"), new DateTime(2021, 6, 16, 15, 30, 19, 390, DateTimeKind.Local).AddTicks(5458), "LocalizationSeedData", false, "EndTime must be later than StartTime", "de", null, null, "Validator", "Endzeit muss später Startzeit sein" },
                    { new Guid("da208786-f55a-4b32-92c2-365184ffe604"), new DateTime(2021, 6, 16, 15, 30, 19, 390, DateTimeKind.Local).AddTicks(9011), "LocalizationSeedData", false, "Password must be at least 6 characters", "de", null, null, "Validator", "Das Passwort muss mindestens 6 Zeichen enthalten" },
