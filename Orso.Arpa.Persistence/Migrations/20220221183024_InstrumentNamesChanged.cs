...
{
    public partial class InstrumentNamesChanged : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("005e6fdf-fa34-4bb8-94c1-e006174d22d5"), new DateTime(2022, 2, 21, 19, 30, 18, 403, DateTimeKind.Local).AddTicks(560), "LocalizationSeedData", false, "Contra Bassoon", "de", null, null, "SectionDto", "Kontrafagott" },
                    { new Guid("05b3e8f4-c0fa-4f63-b6d2-d848f0d98edf"), new DateTime(2022, 2, 21, 19, 30, 18, 397, DateTimeKind.Local).AddTicks(2850), "LocalizationSeedData", false, "Tenor Saxophone", "de", null, null, "SectionDto", "Tenor-Saxophon" },
                    { new Guid("0b7f95e6-9334-4553-a65d-6e87aafa05ad"), new DateTime(2022, 2, 21, 19, 30, 18, 401, DateTimeKind.Local).AddTicks(6120), "LocalizationSeedData", false, "Bassoon", "de", null, null, "SectionDto", "Fagott" },
                    { new Guid("19ba04dd-4f09-4b30-bebb-d1b3253da4f4"), new DateTime(2022, 2, 21, 19, 30, 18, 391, DateTimeKind.Local).AddTicks(3910), "LocalizationSeedData", false, "Double Bass Clarinet", "de", null, null, "SectionDto", "Kontrabass-Klarinette" },
                    { new Guid("1b5973b7-b2ef-42ff-910f-d918a2681183"), new DateTime(2022, 2, 21, 19, 30, 18, 418, DateTimeKind.Local).AddTicks(9120), "LocalizationSeedData", false, "Cornet", "de", null, null, "SectionDto", "Kornett" },
                    { new Guid("20f0d06a-8dab-44fe-9c76-d40d77bca95d"), new DateTime(2022, 2, 21, 19, 30, 18, 345, DateTimeKind.Local).AddTicks(8240), "LocalizationSeedData", false, "Répétiteur", "de", null, null, "SectionDto", "Korrepetitor" },
                    { new Guid("25e78b8c-fb40-4781-a8ce-71e02b92edc0"), new DateTime(2022, 2, 21, 19, 30, 18, 424, DateTimeKind.Local).AddTicks(8610), "LocalizationSeedData", false, "Bass Trombone", "de", null, null, "SectionDto", "Bass-Posaune" },
                    { new Guid("2799add6-d0c6-4a79-923d-6616e18d4a3d"), new DateTime(2022, 2, 21, 19, 30, 18, 448, DateTimeKind.Local).AddTicks(1070), "LocalizationSeedData", false, "Mallets", "de", null, null, "SectionDto", "Stabspiel" },
                    { new Guid("33495d64-2148-41d2-91f8-d3657038e9f1"), new DateTime(2022, 2, 21, 19, 30, 18, 599, DateTimeKind.Local).AddTicks(7270), "LocalizationSeedData", false, "Gladly", "de", null, null, "SelectValueDto", "Gerne anfragen" },
                    { new Guid("3494110c-31b4-4ff0-b29a-c12dc6ea9f44"), new DateTime(2022, 2, 21, 19, 30, 18, 439, DateTimeKind.Local).AddTicks(3720), "LocalizationSeedData", false, "Drum Set (Band)", "de", null, null, "SectionDto", "Schlagzeug (Band)" },
                    { new Guid("38b21350-7ba8-4332-91e7-161aa4078048"), new DateTime(2022, 2, 21, 19, 30, 18, 404, DateTimeKind.Local).AddTicks(4920), "LocalizationSeedData", false, "Contraforte", "de", null, null, "SectionDto", "Kontraforte" },
                    { new Guid("38e33e88-0bd2-4c63-b127-e584b4d7eeaf"), new DateTime(2021, 11, 6, 14, 56, 26, 648, DateTimeKind.Local).AddTicks(6980), "LocalizationSeedData", false, "Orchestra Concert Rate: 9€/11€ at 12h", "de", null, null, "SelectValueDto", "Orchester Konzertpauschale 9€/11€ bei 12h" },
                    { new Guid("434a4997-51cc-4b20-9ab0-d3d07b42f3f1"), new DateTime(2022, 2, 21, 19, 30, 18, 426, DateTimeKind.Local).AddTicks(3230), "LocalizationSeedData", false, "Double Bass Trombone", "de", null, null, "SectionDto", "Kontrabass-Posaune" },
                    { new Guid("492d17c9-a707-4610-9e29-d4570e841db7"), new DateTime(2022, 2, 21, 19, 30, 18, 604, DateTimeKind.Local).AddTicks(1290), "LocalizationSeedData", false, "Never again", "de", null, null, "SelectValueDto", "Nie wieder" },
                    { new Guid("49535afc-f38b-49f7-b28d-568123bb831d"), new DateTime(2022, 2, 21, 19, 30, 18, 423, DateTimeKind.Local).AddTicks(3960), "LocalizationSeedData", false, "Alto Trombone", "de", null, null, "SectionDto", "Alt-Posaune" },
                    { new Guid("4a7da81e-3a79-47f6-beb4-b047ca9dcab8"), new DateTime(2022, 2, 21, 19, 30, 18, 410, DateTimeKind.Local).AddTicks(2340), "LocalizationSeedData", false, "Low Brass", "de", null, null, "SectionDto", "Tiefes Blech" },
                    { new Guid("5100a0ad-25ac-4e7d-a7f9-c9816b02be2e"), new DateTime(2021, 11, 6, 14, 56, 26, 555, DateTimeKind.Local).AddTicks(3686), "LocalizationSeedData", false, "Bass", "de", null, null, "SectionDto", "Bass (Chor)" },
                    { new Guid("54f6c68e-66d2-49cd-bfef-6d9445d36a7a"), new DateTime(2022, 2, 21, 19, 30, 18, 440, DateTimeKind.Local).AddTicks(8600), "LocalizationSeedData", false, "Drum Set (Orchestra)", "de", null, null, "SectionDto", "Schlagzeug (Orchester)" },
                    { new Guid("6bb1df23-d004-4c85-9a6e-52c1fb4757ef"), new DateTime(2022, 2, 21, 19, 30, 18, 347, DateTimeKind.Local).AddTicks(3190), "LocalizationSeedData", false, "Vocal Coach", "de", null, null, "SectionDto", "Stimmbildner:in" },
                    { new Guid("6defbec6-09e1-4714-97c7-688a08ab71b9"), new DateTime(2021, 11, 6, 14, 56, 26, 647, DateTimeKind.Local).AddTicks(9502), "LocalizationSeedData", false, "Orchestra Concert Rate: 9€/11€ at 10h", "de", null, null, "SelectValueDto", "Orchester Konzertpauschale 9€/11€ bei 10h" },
                    { new Guid("72b13ac9-d3ca-445f-a265-294c93f01e8e"), new DateTime(2022, 2, 21, 19, 30, 18, 405, DateTimeKind.Local).AddTicks(9470), "LocalizationSeedData", false, "Bagpipes", "de", null, null, "SectionDto", "Dudelsack" },
                    { new Guid("7dad6ee2-03ed-476f-95df-285f9b47a02f"), new DateTime(2022, 2, 21, 19, 30, 18, 602, DateTimeKind.Local).AddTicks(7130), "LocalizationSeedData", false, "For contacts only", "de", null, null, "SelectValueDto", "Aquisekontakt" },
                    { new Guid("7f9ca4b0-81e2-4668-a896-2787cb0e0fb4"), new DateTime(2022, 2, 21, 19, 30, 18, 388, DateTimeKind.Local).AddTicks(4960), "LocalizationSeedData", false, "Basset Horn", "de", null, null, "SectionDto", "Bassett-Horn" },
                    { new Guid("8314d189-79bf-47a2-8992-50c4f1938825"), new DateTime(2022, 2, 21, 19, 30, 18, 420, DateTimeKind.Local).AddTicks(4120), "LocalizationSeedData", false, "Soprano Cornet", "de", null, null, "SectionDto", "Sopran-Kornett" },
                    { new Guid("856aa561-e5cd-41aa-baf6-02615c3cd078"), new DateTime(2022, 2, 21, 19, 30, 18, 408, DateTimeKind.Local).AddTicks(8110), "LocalizationSeedData", false, "High Brass", "de", null, null, "SectionDto", "Hohes Blech" },
                    { new Guid("a2f18201-d78f-4b08-8c23-674399b3eeff"), new DateTime(2022, 2, 21, 19, 30, 18, 486, DateTimeKind.Local).AddTicks(9880), "LocalizationSeedData", false, "Double Bass", "de", null, null, "SectionDto", "Kontrabass" },
                    { new Guid("b131383c-d3e5-4222-8556-61aa6f59aa0e"), new DateTime(2021, 11, 6, 14, 56, 26, 647, DateTimeKind.Local).AddTicks(1795), "LocalizationSeedData", false, "Orchestra Concert Rate: 1808", "de", null, null, "SelectValueDto", "Orchester Konzertpauschale 1808" },
                    { new Guid("b59eb98b-fd21-495c-9ff6-0a50b0d1e412"), new DateTime(2022, 2, 21, 19, 30, 18, 342, DateTimeKind.Local).AddTicks(6210), "LocalizationSeedData", false, "Conductor", "de", null, null, "SectionDto", "Dirigent" },
                    { new Guid("b5d969f5-115e-4831-bcc7-d724070ea89a"), new DateTime(2022, 2, 21, 19, 30, 18, 472, DateTimeKind.Local).AddTicks(6230), "LocalizationSeedData", false, "Electric Bass (Orchestra)", "de", null, null, "SectionDto", "E-Bass (Orchester)" },
                    { new Guid("c1822bcb-6922-4d16-8cf7-6185a506f208"), new DateTime(2022, 2, 21, 19, 30, 18, 340, DateTimeKind.Local).AddTicks(7520), "LocalizationSeedData", false, "Contractors", "de", null, null, "SectionDto", "Vertragspartner" },
                    { new Guid("d1315669-0dde-4dda-9332-aefc0af43aa0"), new DateTime(2022, 2, 21, 19, 30, 18, 344, DateTimeKind.Local).AddTicks(1210), "LocalizationSeedData", false, "Assistant Conductor", "de", null, null, "SectionDto", "Dirigierassistent" },
                    { new Guid("e1ea9df1-b1c1-43e6-b376-9ffb222d800f"), new DateTime(2022, 2, 21, 19, 30, 18, 421, DateTimeKind.Local).AddTicks(9140), "LocalizationSeedData", false, "Trombone", "de", null, null, "SectionDto", "Posaune" },
                    { new Guid("ea96a43f-613e-44ee-a5ce-236c634bf9a9"), new DateTime(2022, 2, 21, 19, 30, 18, 452, DateTimeKind.Local).AddTicks(4050), "LocalizationSeedData", false, "GlassHarp", "de", null, null, "SectionDto", "Glasharfe" },
                    { new Guid("f747b09b-1f47-498d-b847-1bbcb3570a95"), new DateTime(2022, 2, 21, 19, 30, 18, 601, DateTimeKind.Local).AddTicks(2570), "LocalizationSeedData", false, "Emergency only", "de", null, null, "SelectValueDto", "Nur im Notfall" },
                    { new Guid("fc3085a9-71ed-4d0f-965a-4240a0a9518e"), new DateTime(2022, 2, 21, 19, 30, 18, 469, DateTimeKind.Local).AddTicks(6770), "LocalizationSeedData", false, "Electric Guitar (Orchestra)", "de", null, null, "SectionDto", "E-Gitarre (Orchester)" },
                    { new Guid("fcdf4875-c231-4f53-947e-b9d24f942f46"), new DateTime(2022, 2, 21, 19, 30, 18, 466, DateTimeKind.Local).AddTicks(7990), "LocalizationSeedData", false, "Acoustic Guitar (Orchestra)", "de", null, null, "SectionDto", "Akustik-Gitarre (Orchester)" },
                    { new Guid("fd7c73d5-edcb-4cd8-b2e2-ce9166340062"), new DateTime(2022, 2, 21, 19, 30, 18, 436, DateTimeKind.Local).AddTicks(4640), "LocalizationSeedData", false, "Timpani", "de", null, null, "SectionDto", "Pauken" }
                });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("005e6fdf-fa34-4bb8-94c1-e006174d22d5"));

            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("05b3e8f4-c0fa-4f63-b6d2-d848f0d98edf"));

            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("0b7f95e6-9334-4553-a65d-6e87aafa05ad"));

            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("19ba04dd-4f09-4b30-bebb-d1b3253da4f4"));

            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("1b5973b7-b2ef-42ff-910f-d918a2681183"));

            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("20f0d06a-8dab-44fe-9c76-d40d77bca95d"));

            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("25e78b8c-fb40-4781-a8ce-71e02b92edc0"));

            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("2799add6-d0c6-4a79-923d-6616e18d4a3d"));

            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("33495d64-2148-41d2-91f8-d3657038e9f1"));

            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("3494110c-31b4-4ff0-b29a-c12dc6ea9f44"));

            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("38b21350-7ba8-4332-91e7-161aa4078048"));
            ...
            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("434a4997-51cc-4b20-9ab0-d3d07b42f3f1"));

            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("492d17c9-a707-4610-9e29-d4570e841db7"));

            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("49535afc-f38b-49f7-b28d-568123bb831d"));

            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("4a7da81e-3a79-47f6-beb4-b047ca9dcab8"));
            ...
            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("54f6c68e-66d2-49cd-bfef-6d9445d36a7a"));

            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("6bb1df23-d004-4c85-9a6e-52c1fb4757ef"));
            ...
            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("72b13ac9-d3ca-445f-a265-294c93f01e8e"));

            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("7dad6ee2-03ed-476f-95df-285f9b47a02f"));

            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("7f9ca4b0-81e2-4668-a896-2787cb0e0fb4"));

            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("8314d189-79bf-47a2-8992-50c4f1938825"));

            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("856aa561-e5cd-41aa-baf6-02615c3cd078"));

            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("a2f18201-d78f-4b08-8c23-674399b3eeff"));
            ...
            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("b59eb98b-fd21-495c-9ff6-0a50b0d1e412"));

            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("b5d969f5-115e-4831-bcc7-d724070ea89a"));

            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("c1822bcb-6922-4d16-8cf7-6185a506f208"));

            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("d1315669-0dde-4dda-9332-aefc0af43aa0"));

            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("e1ea9df1-b1c1-43e6-b376-9ffb222d800f"));

            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("ea96a43f-613e-44ee-a5ce-236c634bf9a9"));

            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("f747b09b-1f47-498d-b847-1bbcb3570a95"));

            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("fc3085a9-71ed-4d0f-965a-4240a0a9518e"));

            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("fcdf4875-c231-4f53-947e-b9d24f942f46"));

            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("fd7c73d5-edcb-4cd8-b2e2-ce9166340062"));
