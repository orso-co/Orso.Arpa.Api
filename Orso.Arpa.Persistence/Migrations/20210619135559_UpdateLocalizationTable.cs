...
{
    public partial class UpdateLocalizationTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("97fde212-3305-4fb9-b0a8-a12a8efb2872"), new DateTime(2021, 6, 16, 15, 30, 19, 324, DateTimeKind.Local).AddTicks(7866), "LocalizationSeedData", false, "Invalid token supplied", "en", null, null, "Validator", "Please try to login again" },
                    ...
                    { new Guid("39e5d409-aa17-4bcc-94dc-dc5b576fd910"), new DateTime(2021, 6, 16, 15, 30, 19, 390, DateTimeKind.Local).AddTicks(1201), "LocalizationSeedData", false, "Invalid token supplied", "de-DE", null, null, "Validator", "Ungültiges Token angegeben" },
                    { new Guid("4899a356-74c0-4f48-9ca5-2a716f7718ab"), new DateTime(2021, 6, 16, 15, 30, 19, 389, DateTimeKind.Local).AddTicks(7493), "LocalizationSeedData", false, "This request requires a valid JWT access token to be provided", "de-DE", null, null, "Validator", "Diese Anfrage erfordert einen gültigen JWT Token" },
                    { new Guid("1cc1999c-eec3-4891-a833-798a8ec6baae"), new DateTime(2021, 6, 16, 15, 30, 19, 386, DateTimeKind.Local).AddTicks(6960), "LocalizationSeedData", false, "Invalid token supplied", "en-GB", null, null, "Validator", "Please try to login again" },
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DeleteData(
                table: "localizations",
                keyColumn: "id",
                keyValue: new Guid("97fde212-3305-4fb9-b0a8-a12a8efb2872"));
