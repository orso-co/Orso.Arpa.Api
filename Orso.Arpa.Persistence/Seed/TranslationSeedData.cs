...
namespace Orso.Arpa.Persistence.Seed
{
    public static class TranslationSeedData
    {
        ...
        private static Translation AccountLocked_de_DE = new("Your account is locked. Kindly wait for 10 minutes and try again",
            "Dein Konto wurde gesperrt. Bitte warte 10 Minuten und versuche es anschließend erneut","de-DE","DomainResource"
        );
