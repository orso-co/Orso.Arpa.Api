...
*/
        ...
        public static Section Flute => new(Guid.Parse("d6961f83-e792-4ddf-b91a-ae0867caeb3b"), "Flute", Woodwinds.Id, true);
        public static Section PiccoloFlute => new(Guid.Parse("ec8aeaf8-f370-4ac8-bd12-ccce0cbcfa0f"), "Piccolo Flute", Flute.Id, false);
        ...
        public static Section Oboe => new(Guid.Parse("2327a9c3-2c6f-41b7-9045-bb00af798b42"), "Oboe", Woodwinds.Id, true);
        public static Section OboeDAmore => new(Guid.Parse("4e71ffc3-e086-4c16-a932-3d80fd302971"), "Oboe d'Amore", Oboe.Id, false);
        public static Section EnglishHorn => new(Guid.Parse("abe0d27b-2c99-4755-891c-fb0b91f19bb6"), "English Horn", Oboe.Id, false);
        public static Section BaritonOboe => new(Guid.Parse("2f8d732f-bf82-4a62-86a1-62bffd708189"), "Bariton Oboe", Oboe.Id, false);
        public static Section Clarinet => new(Guid.Parse("cdc390d5-0649-441d-a086-df2e3b9d3512"), "Clarinet", Woodwinds.Id, true);
        public static Section EbClarinet => new(Guid.Parse("d2551427-d727-42d9-be0e-dea2ae82f2d6"), "Eb Clarinet", Clarinet.Id, false);
        ...
        public static Section Bassoon => new(Guid.Parse("5c14f673-13f2-488f-8c21-7286d3ee10c3"), "Bassoon", Woodwinds.Id, true);
        ...
        public static Section AltoSaxophone => new(Guid.Parse("4a31447d-63c2-4e28-ab39-255a956fbe18"), "Alto Saxophone", Saxophone.Id, false);
        public static Section TenorSaxophone => new(Guid.Parse("da998fcb-92b9-4828-976e-826e97e05cb3"), "Tenor Saxophone", Saxophone.Id, false);
        ...
        public static Section Horn => new(Guid.Parse("b9532add-efec-4510-831c-902c32ef7dbb"), "Horn", HighBrass.Id, true);
        public static Section WagnerTuba => new(Guid.Parse("c42591db-4e41-413f-8b98-6607e2f12e39"), "Wagner Tuba", Horn.Id, false);
        public static Section Trumpet => new(Guid.Parse("205b0a0e-1a36-48e9-8b45-df37dc5effa5"), "Trumpet", HighBrass.Id, true);
        public static Section Flugelhorn => new(Guid.Parse("69e64d64-419f-4f9c-9948-a117b02ff198"), "Flugelhorn", Trumpet.Id, false);
        ...
        public static Section Cornet => new(Guid.Parse("305C06E0-B99F-4F91-AE83-869D8B25C63D"), "Cornet", Trumpet.Id, false);
        public static Section LowBrass => new(Guid.Parse("e4e7239e-0d0d-4a30-93b6-8a61e3ab8041"), "Low Brass", Brass.Id, false);
        public static Section Trombone => new(Guid.Parse("e20ce055-5715-42f4-97e6-4025559b15f7"), "Trombone", LowBrass.Id, true);
        public static Section AltoTrombone => new(Guid.Parse("80f15184-6417-476a-87ac-0f752d011391"), "Alto Trombone", Trombone.Id, false);
        public static Section BassTrombone => new(Guid.Parse("da660c21-0151-4255-a81b-4d25fede199b"), "Bass Trombone", Trombone.Id, false);
        ...
        public static Section Euphonium => new(Guid.Parse("554fd3db-110b-4335-bc2a-1d5070f6621a"), "Euphonium", LowBrass.Id, true);
        public static Section TenorHorn => new(Guid.Parse("803219AA-1A32-4A68-95AE-348BD487135A"), "Tenor Horn", Euphonium.Id, false);
        public static Section BaritoneHorn => new(Guid.Parse("B525E539-7FA4-49D7-AE93-EC0748022D4D"), "Baritone Horn", Euphonium.Id, false);
        public static Section Tuba => new(Guid.Parse("18cbded8-0d64-4e0e-bc19-d6903e0fd5a9"), "Tuba", LowBrass.Id, true);
        public static Section EbTuba => new(Guid.Parse("2FABD3A1-D398-4108-A74F-2665710133D1"), "Eb Tuba", Tuba.Id, false);
        public static Section FTuba => new(Guid.Parse("31A2B9BF-0C2B-47EC-B8BC-34C9423B74D4"), "F Tuba", Tuba.Id, false);

        // PERCUSSION
        public static Section Percussion => new(Guid.Parse("0558a5ff-ee27-44a1-82ab-d0c0cc018c3c"), "Percussion", Orchestra.Id, false);
        public static Section Timpani => new(Guid.Parse("ea916a8d-1bce-4e87-b5b0-ff6304bb01a5"), "Timpani", Percussion.Id, true);
