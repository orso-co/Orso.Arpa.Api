...
namespace Orso.Arpa.Domain.Entities
{
    public class Appointment : BaseEntity
    {
        ...
        public virtual SelectValueMap Category { get; private set; }
        ...
        public virtual SelectValueMap Status { get; private set; }
        public Guid? EmolumentId { get; private set; }
        public virtual SelectValueMap Emolument { get; private set; }
