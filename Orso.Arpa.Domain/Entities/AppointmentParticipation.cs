...
namespace Orso.Arpa.Domain.Entities
{
    public class AppointmentParticipation : BaseEntity
    {
        ...
        public virtual SelectValueMap Result { get; private set; }
        public Guid? PredictionId { get; private set; }
        public virtual SelectValueMap Prediction { get; private set; }
        public Guid? ExpectationId { get; private set; }
        public virtual SelectValueMap Expectation { get; private set; }
    }
}
