...
{
    public static class ModifyCurriculumVitaeReference
    {
                ...
                else
                {
                    RuleFor(d => d.Id)
                        .MustAsync(async (id, cancellation) => await arpaContext
                            .EntityExistsAsync<CurriculumVitaeReference>(e => e.Id == id && e.MusicianProfile.PersonId == tokenAccessor.PersonId, cancellation))
                        .WithErrorCode("404")
