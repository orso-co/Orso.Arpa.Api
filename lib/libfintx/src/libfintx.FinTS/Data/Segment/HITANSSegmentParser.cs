...
namespace libfintx.FinTS.Data.Segment
{
    internal class HITANSSegmentParser : ISegmentParser
    {
        public Segment ParseSegment(Segment segment)
        {
            ...
            // NOTE: The v6/v7 branch code in upstream was broken (referenced a nested
            // DataElements type that doesn't exist on the string-based Segment.DataElements).
            // Using the regex-based fallback for all versions, which works correctly.
            {
