...
*/
        ...
        public static SectionDto Flute => new() { Id = Guid.Parse("d6961f83-e792-4ddf-b91a-ae0867caeb3b"), Name = "Flute", };
        public static SectionDto PiccoloFlute => new() { Id = Guid.Parse("ec8aeaf8-f370-4ac8-bd12-ccce0cbcfa0f"), Name = "Piccolo Flute", };
        ...
        public static SectionDto Oboe => new() { Id = Guid.Parse("2327a9c3-2c6f-41b7-9045-bb00af798b42"), Name = "Oboe", };
        public static SectionDto OboeDAmore => new() { Id = Guid.Parse("4e71ffc3-e086-4c16-a932-3d80fd302971"), Name = "Oboe d'Amore", };
        public static SectionDto EnglishHorn => new() { Id = Guid.Parse("abe0d27b-2c99-4755-891c-fb0b91f19bb6"), Name = "English Horn", };
        public static SectionDto BaritonOboe => new() { Id = Guid.Parse("2f8d732f-bf82-4a62-86a1-62bffd708189"), Name = "Bariton Oboe", };
        public static SectionDto Clarinet => new() { Id = Guid.Parse("cdc390d5-0649-441d-a086-df2e3b9d3512"), Name = "Clarinet", };
        public static SectionDto EbClarinet => new() { Id = Guid.Parse("d2551427-d727-42d9-be0e-dea2ae82f2d6"), Name = "Eb Clarinet", };
        public static SectionDto AltoClarinet => new() { Id = Guid.Parse("BE75913A-9703-4A8D-9E07-7A8D32C459F8"), Name = "Alto Clarinet", };
        public static SectionDto Bassetthorn => new() { Id = Guid.Parse("8c0a80d1-5889-4794-89b6-b80a3828aa5b"), Name = "Basset Horn", };
        public static SectionDto BassClarinet => new() { Id = Guid.Parse("5109e464-7b01-40bd-a5e0-398ac3d1bb83"), Name = "Bass Clarinet", };
        ...
        public static SectionDto Bassoon => new() { Id = Guid.Parse("5c14f673-13f2-488f-8c21-7286d3ee10c3"), Name = "Bassoon", };
        public static SectionDto ContraBassoon => new() { Id = Guid.Parse("8d01524c-7c22-4a20-8f26-711d11addbfd"), Name = "Contra Bassoon", };
        ...
        public static SectionDto AltoSaxophone => new() { Id = Guid.Parse("4a31447d-63c2-4e28-ab39-255a956fbe18"), Name = "Alto Saxophone", };
        public static SectionDto TenorSaxophone => new() { Id = Guid.Parse("da998fcb-92b9-4828-976e-826e97e05cb3"), Name = "Tenor Saxophone", };
        ...
        public static SectionDto Horn => new() { Id = Guid.Parse("b9532add-efec-4510-831c-902c32ef7dbb"), Name = "Horn", };
        public static SectionDto WagnerTuba => new() { Id = Guid.Parse("c42591db-4e41-413f-8b98-6607e2f12e39"), Name = "Wagner Tuba", };
        public static SectionDto Trumpet => new() { Id = Guid.Parse("205b0a0e-1a36-48e9-8b45-df37dc5effa5"), Name = "Trumpet", };
        public static SectionDto Flugelhorn => new() { Id = Guid.Parse("69e64d64-419f-4f9c-9948-a117b02ff198"), Name = "Flugelhorn", };
        ...
        public static SectionDto Cornet => new() { Id = Guid.Parse("305C06E0-B99F-4F91-AE83-869D8B25C63D"), Name = "Cornet", };
        public static SectionDto LowBrass => new() { Id = Guid.Parse("e4e7239e-0d0d-4a30-93b6-8a61e3ab8041"), Name = "Low Brass", };
        public static SectionDto Trombone => new() { Id = Guid.Parse("e20ce055-5715-42f4-97e6-4025559b15f7"), Name = "Trombone", };
        public static SectionDto AltoTrombone => new() { Id = Guid.Parse("80f15184-6417-476a-87ac-0f752d011391"), Name = "Alto Trombone", };
        public static SectionDto BassTrombone => new() { Id = Guid.Parse("da660c21-0151-4255-a81b-4d25fede199b"), Name = "Bass Trombone", };
        ...
        public static SectionDto Euphonium => new() { Id = Guid.Parse("554fd3db-110b-4335-bc2a-1d5070f6621a"), Name = "Euphonium", };
        public static SectionDto TenorHorn => new() { Id = Guid.Parse("803219AA-1A32-4A68-95AE-348BD487135A"), Name = "Tenor Horn", };
        public static SectionDto BaritoneHorn => new() { Id = Guid.Parse("B525E539-7FA4-49D7-AE93-EC0748022D4D"), Name = "Baritone Horn", };
        public static SectionDto Tuba => new() { Id = Guid.Parse("18cbded8-0d64-4e0e-bc19-d6903e0fd5a9"), Name = "Tuba", };
        public static SectionDto EbTuba => new() { Id = Guid.Parse("2FABD3A1-D398-4108-A74F-2665710133D1"), Name = "Eb Tuba", };
        public static SectionDto FTuba => new() { Id = Guid.Parse("31A2B9BF-0C2B-47EC-B8BC-34C9423B74D4"), Name = "F Tuba", };


        public static SectionDto Percussion => new() { Id = Guid.Parse("0558a5ff-ee27-44a1-82ab-d0c0cc018c3c"), Name = "Percussion", };
        public static SectionDto Timpani => new() { Id = Guid.Parse("ea916a8d-1bce-4e87-b5b0-ff6304bb01a5"), Name = "Timpani", };
        ...
        public static SectionDto Harp => new() { Id = Guid.Parse("0cf93477-f42f-46c3-8e3d-45ccdc54ad8c"), Name = "Harp", };
        public static SectionDto Keyboards => new() { Id = Guid.Parse("614a8fd0-acfa-4268-b716-3b35a6a17b7a"), Name = "Keyboards", };
        public static SectionDto Piano => new() { Id = Guid.Parse("8ed82e0e-0354-4192-8f26-5a2437e9208d"), Name = "Piano", };
        ...
        public static SectionDto AcousticGuitar => new() { Id = Guid.Parse("1d0ed0b3-b87b-439f-932e-616d7e03a0d6"), Name = "Acoustic Guitar (Orchestra)", };
        public static SectionDto ElectricGuitar => new() { Id = Guid.Parse("ed0829d0-d978-430e-96ec-b93cf75f3fd6"), Name = "Electric Guitar (Orchestra)", };
        ...
        public static SectionDto GlassHarp => new() { Id = Guid.Parse("08bc313b-d0dd-4b78-bdbf-d976682d965e"), Name = "GlassHarp", };
        ...
        public static SectionDto ElectricGuitarBand => new() { Id = Guid.Parse("48833c1b-cbc1-43b2-a4c5-f1fa4289f5ab"), Name = "Electric Guitar (Band)", };
