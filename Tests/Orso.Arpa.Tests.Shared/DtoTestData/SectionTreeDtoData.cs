        ...
        public static SectionTreeDto Level2SectionTreeDto => new SectionTreeDto
        {
            ...
            Children = new List<SectionTreeDto>
            {
                new SectionTreeDto { Data = SectionDtoData.Performers,      IsLeaf = false, Level = 1, IsRoot = false, Children = new List<SectionTreeDto> {
                    new SectionTreeDto { Data = SectionDtoData.Conductor,   IsLeaf = true,  Level = 2, IsRoot = false, Children = new List<SectionTreeDto>() },
                ...
                new SectionTreeDto { Data = SectionDtoData.Members,         IsLeaf = true,  Level = 1, IsRoot = false, Children = new List<SectionTreeDto>() },
                ...
                new SectionTreeDto { Data = SectionDtoData.Suppliers,       IsLeaf = true,  Level = 1, IsRoot = false, Children = new List<SectionTreeDto>() },
                new SectionTreeDto { Data = SectionDtoData.Contractors,     IsLeaf = true,  Level = 1, IsRoot = false, Children = new List<SectionTreeDto>() },
            }
        };
    }
}
