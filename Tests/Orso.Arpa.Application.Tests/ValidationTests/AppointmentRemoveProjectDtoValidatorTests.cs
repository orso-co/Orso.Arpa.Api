...
namespace Orso.Arpa.Application.Tests.ValidationTests
{
    ...
    public class AppointmentRemoveProjectDtoValidatorTests
    {
        ...
        {
            _validator.ShouldHaveValidationErrorForExactAsync(command => command.ProjectId, Guid.Empty);
        }

        [Test]
        public void Should_Not_Have_Validation_Error_If_Valid_ProjectId_Is_Supplied()
        {
            _validator.ShouldNotHaveValidationErrorForExactAsync(command => command.ProjectId, Guid.NewGuid());
        }
    }
}
