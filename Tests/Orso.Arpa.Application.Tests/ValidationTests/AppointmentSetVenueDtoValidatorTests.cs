...
namespace Orso.Arpa.Application.Tests.ValidationTests
{
    ...
    public class AppointmentSetVenueDtoValidatorTests
    {
        ...
        {
            _validator.ShouldHaveValidationErrorForExactAsync(command => command.VenueId, Guid.Empty);
        }

        [Test]
        public void Should_Not_Have_Validation_Error_If_Valid_VenueId_Is_Supplied()
        {
            _validator.ShouldNotHaveValidationErrorForExactAsync(command => command.VenueId, Guid.NewGuid());
        }
    }
}
