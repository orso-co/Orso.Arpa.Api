...
namespace Orso.Arpa.Domain.Tests.AppointmentTests.CommandHandlerTests
{
    ...
    public class AddProjectHandlerTests
    {
        ...
        public void Setup()
        {
            ...
            _handler = new AddProject.Handler(_repository, _unitOfWork, _mapper);
        }
        ...
        public async Task Should_Add_Project()
        {
            ...
            // Act
            Unit result = await _handler.Handle(new AddProject.Command(Guid.NewGuid(), Guid.NewGuid()), new CancellationToken());
