...
namespace Orso.Arpa.Domain.Tests.UrlTests.ValidatorTests
{
    ...
    public class UrlModifyCommandValidatorTests
    {
        ...
        public void Should_Not_Have_Validation_Error_If_Valid_Id_Is_Supplied()
        {
            ...
            _validator.ShouldNotHaveValidationErrorForExactAsync(c => c.Id, UrlSeedData.ArpaWebsite.Id);
        }
        ...
        public void Should_Have_Validation_Error_If_Id_Does_Not_Exist()
        {
            ...
            _validator.ShouldHaveNotFoundErrorForAsync(c => c.Id, Guid.NewGuid(), nameof(Url));
        }
    }
}
