...
namespace Orso.Arpa.Domain.Tests.UsersTests.QueryHandlerTests
{
    public class DetailsHandlerTests
    {
        ...
        public void Setup()
        {
            ...
            _handler = new UserDetails.Handler(_userManager);
        }

        private ArpaUserManager _userManager;
        private UserDetails.Handler _handler;
        ...
        public async Task Should_Get_User_By_Id()
        {
            ...
            var query = new UserDetails.Query(expectedUser.Id);
        ...
        {
            // Arrange
            var query = new UserDetails.Query(Guid.NewGuid());
